...
if FLAGS.dataset_name == "BraTS2019":
    model_path = FLAGS.root_path + "model/{}_{}_{}_labeled/{}/savefreq{}-adamw-{}-{}/{}_{}_best_model.pth".format(FLAGS.dataset_name, FLAGS.exp, FLAGS.labelnum,FLAGS.model, FLAGS.savefreq, FLAGS.adamw_lr, FLAGS.decay, FLAGS.exp, FLAGS.iter)
else:
    model_path = FLAGS.root_path + "model/{}_{}_{}_labeled/{}/savefreq{}-adamw-{}-{}/{}_best_model.pth".format(FLAGS.dataset_name, FLAGS.exp, FLAGS.labelnum,FLAGS.model, FLAGS.savefreq, FLAGS.adamw_lr, FLAGS.decay, FLAGS.exp)
